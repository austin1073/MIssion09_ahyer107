...
namespace MIssion09_ahyer107.Models
{
    public class Basket
    {
        public List<BasketLineItem> Items { get; set; } = new List<BasketLineItem>(); //Declaration and then instantiation
        ...
        {
            Items.Clear(); //Gets rid of everything in the items list
        }
